                ...
                for gpu in range(num_gpus):
                    ...
                    if True:
                        ...
                        if out_shrink > 1:
                            ...
                            out_expr_ = [tf.nn.avg_pool(tf.transpose(x, [0, 2, 3, 1]), ksize=ksize, strides=ksize, padding='VALID', data_format='NHWC') for x in out_expr]
                            out_expr = tf.transpose(out_expr_, [0, 3, 1, 2])
